...
extern void *vp_os_calloc(size_t nmemb, size_t size);
extern void *vp_os_malloc(size_t size);
extern void  vp_os_free(void *ptr);
extern void *vp_os_realloc(void *ptr, size_t size);
extern void *vp_os_memset(void *s, int c, size_t n);
...
#define calloc  vp_os_calloc
#define malloc  vp_os_malloc
#define memset  vp_os_memset
#define free    vp_os_free
#define realloc vp_os_realloc
*/
